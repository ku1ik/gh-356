...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19386__auto__,writer__19387__auto__,opt__19388__auto__){
return cljs.core._write.call(null,writer__19387__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__18788__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__18788__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__18788__auto__)){
return or__18788__auto__;
} else {
...
var G__27958 = o;
(G__27958[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__27959__delegate = function (args){
...
while (G__27960__i < G__27960__a.length) {G__27960__a[G__27960__i] = arguments[G__27960__i + 0]; ++G__27960__i;}
  args = new cljs.core.IndexedSeq(G__27960__a,0);
} 
return G__27959__delegate.call(this,args);};
...
return G__27959__delegate(args);
});
...
var old_27962 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_27962))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_27962)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__18776__auto__ = (node === document.activeElement);
if(and__18776__auto__){
var and__18776__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__18776__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__27965 = jsprops;
(G__27965["defaultValue"] = value);

(G__27965["onChange"] = ((function (G__27965,v,value,on_change){
return (function (p1__27963_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27963_SHARP_);
});})(G__27965,v,value,on_change))
);
...
var vec__27967 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27967,(0),null);
var id = cljs.core.nth.call(null,vec__27967,(1),null);
var class$ = cljs.core.nth.call(null,vec__27967,(2),null);
...
var temp__4427__auto__ = (function (){var G__27971 = cljs.core.meta.call(null,v);
var G__27971__$1 = (((G__27971 == null))?null:reagent.impl.template.get_key.call(null,G__27971));
return G__27971__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__27973_27974 = v;
var G__27973_27975__$1 = (((G__27973_27974 == null))?null:reagent.impl.template.key_from_vec.call(null,G__27973_27974));
var G__27973_27976__$2 = (((G__27973_27975__$1 == null))?null:(jsprops["key"] = G__27973_27975__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__27979 = cljs.core.meta.call(null,argv);
var G__27979__$1 = (((G__27979 == null))?null:reagent.impl.template.get_key.call(null,G__27979));
return G__27979__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__27980 = (((jsprops == null))?{}:jsprops);
(G__27980["key"] = key);
...
var G__27981 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27981;
continue;
}
} else {
...
var n__19691__auto___27982 = a.length;
var i_27983 = (0);
while(true){
if((i_27983 < n__19691__auto___27982)){
(a[i_27983] = reagent.impl.template.as_element.call(null,(a[i_27983])));

var G__27984 = (i_27983 + (1));
i_27983 = G__27984;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19691__auto___27985 = a.length;
var i_27986 = (0);
while(true){
if((i_27986 < n__19691__auto___27985)){
var val_27987 = (a[i_27986]);
if((cljs.core.vector_QMARK_.call(null,val_27987)) && ((reagent.impl.template.key_from_vec.call(null,val_27987) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27986] = reagent.impl.template.as_element.call(null,val_27987));

var G__27988 = (i_27986 + (1));
i_27986 = G__27988;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__18776__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__18776__auto__){
return (ctx["no-key"]);
} else {
return and__18776__auto__;
...
var G__27990 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27990) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27990){
