...
var m__19444__auto__ = (schema.spec.core.subschemas[goog.typeOf(x__19443__auto__)]);
if(!((m__19444__auto__ == null))){
return m__19444__auto__.call(null,this$);
} else {
var m__19444__auto____$1 = (schema.spec.core.subschemas["_"]);
...
var x__19443__auto__ = (((this$ == null))?null:this$);
var m__19444__auto__ = (schema.spec.core.checker[goog.typeOf(x__19443__auto__)]);
if(!((m__19444__auto__ == null))){
return m__19444__auto__.call(null,this$,params);
} else {
var m__19444__auto____$1 = (schema.spec.core.checker["_"]);
if(!((m__19444__auto____$1 == null))){
return m__19444__auto____$1.call(null,this$,params);
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__23675,p__23676){
var map__23681 = p__23675;
...
var schema__$1 = cljs.core.get.call(null,map__23681__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__23681__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__23682 = p__23676;
...
var params = map__23682__$1;
var subschema_checker = cljs.core.get.call(null,map__23682__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__23682__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache))
});})(map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache))
,((function (map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache){
return (function (){
return subschema_checker.call(null,schema__$1,params);
});})(map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache))
);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__23681,map__23681__$1,schema__$1,error_wrap,map__23682,map__23682__$1,params,subschema_checker,cache))
} else {
return sub;
}
});
